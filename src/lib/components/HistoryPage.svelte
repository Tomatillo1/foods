				...
				{#if confirmReset}
					<div class="flex gap-2">
						<button
							...
							class="bg-[#22c55e] text-white border-none px-2 py-2 rounded-xl text-xs font-bold cursor-pointer"
							>Non</button
						>
						<button
					...
					<div class="flex justify-between items-center mb-5">
						...
						<div class="flex items-baseline gap-1">
							<span
								...
								OBJECTIFS.calories
									? 'text-[#ef4444]'
									: 'text-[#22c55e]'}">{jour.calories}</span
							>
							<span
					...
					>
						<div class="flex flex-col gap-1">
							...
							<span
								...
								OBJECTIFS.proteines
									? 'text-[#ef4444]'
									: 'text-[#334155]'}">{jour.proteines}g</span
							>
						</div>
						<div class="flex flex-col gap-1">
							<span
